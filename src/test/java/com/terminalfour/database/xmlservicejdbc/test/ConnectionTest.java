...
public class ConnectionTest {
	...
	@Test
	public void openConnectionEmpty ()
	...
	@Test
	public void openConnectionValidURL ()
			throws SQLException, ClassNotFoundException {
		Connection conn = DriverManager
				.getConnection ("jdbc:xmlservice:https://democe.campusit.net/app/democe/solar.qll_web.curriculum?id=00124303&auth=demokey");
		conn.close ();
	}

	@Test
	public void openConnectionValidFile ()
			throws SQLException, ClassNotFoundException {
